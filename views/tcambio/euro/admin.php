<main>
    <div class="header-admin">
        <h1>Administrador de Tipo de Cambio Euro</h1>
        <?php
        if ($resultado) {
        ...
        <div class="row">
            <div class="col">
                <h2>Tipo de Cambio Euro</h2>
            </div>
            <div class="d-flex justify-content-end mb-4"> <!-- Contenedor flexible alineado a la derecha -->
                <a href="/tcambio/euro/crear" class="btn btn-primary rounded-pill shadow-sm">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div class="d-flex justify-content-center gap-2">
                                <a href="/tcambio/euro/actualizar?id=<?php echo s($tipocambio->id); ?>"
                                    class="btn btn-sm btn-outline-warning rounded-pill px-3"
                                    title="Editar registro">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>

                                <form method="POST" action="/tcambio/euro/eliminar" class="d-inline"><?php echo csrf_input(); ?>
                                    <input type="hidden" name="id" value="<?php echo s($tipocambio->id); ?>">
                                    <input type="hidden" name="tipo" value="tipocambioeuro">
                                    <button type="submit"
