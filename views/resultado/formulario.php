<fieldset>
    ...
    <div class="mb-3 w-auto">
        ...
        <input type="text" class="form-control shadow-sm" id="nombre" aria-describedby="nombreHelp" name="nombre" value="<?php echo s($res->nombre); ?>">
        <div id="nombreHelp" class="form-text">Ingrese el nombre que recibirá el Resultado</div>
    </div>
    <div class="mb-3 w-auto">
        <label for="descripcion" class="form-label">Descripción</label>
        <input type="text" class="form-control shadow-sm" id="descripcion" aria-describedby="descripcionHelp" name="descripcion" value="<?php echo s($res->descripcion); ?>">
