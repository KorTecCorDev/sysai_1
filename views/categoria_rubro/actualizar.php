<main class="container">
    <h1>Actualizar Categoría de Rubro</h1>
    ...
    <div class="border rounded-3 shadow-sm p-4 mx-auto my-4" style="max-width: 700px; background-color: #fff;">
        <h4 class="mb-4 text-primary text-uppercase">Actualizar Categoría de Rubro</h4>
        <form method="POST">
            <?php include __DIR__ . '/formulario.php'; ?>
            <div class="d-flex justify-content-between mt-4">
                <a href="/categoria_rubro/admin" class="btn btn-outline-danger rounded-pill px-4 py-2">
