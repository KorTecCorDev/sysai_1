...
- `schema_baseline.sql` — snapshot del esquema previo a los Grupos 8-13. Punto de
  partida para un despliegue desde cero (importar primero, luego correr migraciones).
