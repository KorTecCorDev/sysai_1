...
- [x] **Decisión confirmada (2026-06-04):** el `presupuesto_comprometido` **NO** se calcula al aprobar; se acumula desde **rendiciones + otros egresos** por fuente (`ff_id`) — corresponde a los items 5/6/8. El POA Presupuestal es solo planificación. **⚠️ SUPERADA el 2026-07-09 (migr. 020):** el comprometido de la fuente pasó a ser **Σ de sus sobres** (`detalle_financiamiento.monto_asignado`) — ver `CLAUDE.md` → *Fuentes*. Sigue vigente que no se calcula al aprobar el POA.
