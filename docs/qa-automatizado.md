...
| `qa_rendicion.ps1` | 5 | Rendición imputada al rubro, límite Σ ≤ monto del rubro, cross-tenant, CSRF + **lectura por URL** (2026-09-14): el coordinador recibe 403 al listar productos/actividades/rubros de otro programa cambiando el id, 200 en los suyos, y `/rendicionff/*` ya no existe. **15** |
