...
class SaldoFuenteFinanciamientoVista extends ActiveRecord
{
     ...
     * programa tras la migración 020). El remanente sin asignar = presupuesto − comprometido.
     *
     * @return array<int, array{presupuesto:float, ingresos:float, egresos:float, rendiciones:float, comprometido:float}>
     */
