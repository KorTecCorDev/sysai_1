...
class ReporteIngresosVista extends ActiveRecord
{
    ...
    protected static $columnasDB = ['otros_ingresos_egresos_id', 'otros_ingresos_egresos_fecha', 'otros_ingresos_egresos_codigo', 'otros_ingresos_egresos_descripcion', 'otros_ingresos_egresos_oie_tipo_id',  'fuente_financiamiento_id', 'fuente_financiamiento_codigo', 'oie_tipo_comprobante_id', 'oie_tipo_comprobante_codigo', 'oie_comprobante_fecha_original', 'oie_comprobante_ruc', 'oie_comprobante_razon_social', 'oie_comprobante_serie', 'oie_comprobante_numero', 'oie_comprobante_descripcion', 'oie_comprobante_monto'];
