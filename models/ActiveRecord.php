...
class ActiveRecord
{
    ...
    // Retirados el 2026-08-14 (Fase 2 del plan de reportes): insertarDatosDesdeArray()
    // e insertarDatosDesdeArrayEgresosRendiciones(), ~160 lineas que dibujaban a mano
    // los reportes de ingresos y de egresos. Declaraban 14 encabezados y escribian
    // solo 12 valores, asi que las columnas de MONTO USD y MONTO EUR salian SIEMPRE
    // vacias -tirando a la basura el TC congelado de la migr. 030- y apilaban el
    // presupuesto de las fuentes en la misma columna que los ingresos. Ademas
    // $valores_ordenados no se inicializaba dentro del bucle: un objeto que no
    // cayera en ninguna rama repetia en silencio los valores de la fila anterior.
    // Hoy ese dibujo lo hace models/ReporteMovimientosXlsxBuilder.php.
