...
return array(
    ...
    'Controllers\\ActividadController' => $baseDir . '/controllers/ActividadController.php',
    'Controllers\\CategoriaRubroController' => $baseDir . '/controllers/CategoriaRubroController.php',
    'Controllers\\DetalleActividadController' => $baseDir . '/controllers/DetalleActividadController.php',
    'Controllers\\DetalleFinanciamientoController' => $baseDir . '/controllers/DetalleFinanciamientoController.php',
    'Controllers\\Fuente_FinanciamientoController' => $baseDir . '/controllers/Fuente_FinanciamientoController.php',
    'Controllers\\IngresoEgresoController' => $baseDir . '/controllers/IngresoEgresoController.php',
    ...
    'Controllers\\PoaController' => $baseDir . '/controllers/PoaController.php',
    'Controllers\\PoaIndicadoresController' => $baseDir . '/controllers/PoaIndicadoresController.php',
    'Controllers\\ProductoController' => $baseDir . '/controllers/ProductoController.php',
    'Controllers\\ProgramaController' => $baseDir . '/controllers/ProgramaController.php',
    'Controllers\\RendicionController' => $baseDir . '/controllers/RendicionController.php',
    'Controllers\\ReportePoaRubrosController' => $baseDir . '/controllers/ReportePoaRubrosController.php',
    'Controllers\\ResultadoController' => $baseDir . '/controllers/ResultadoController.php',
    'Controllers\\RubroController' => $baseDir . '/controllers/RubroController.php',
    'Controllers\\SaldoContableController' => $baseDir . '/controllers/SaldoContableController.php',
    'Controllers\\TipoCambioController' => $baseDir . '/controllers/TipoCambioController.php',
    ...
    'Model\\Actividad' => $baseDir . '/models/Actividad.php',
    'Model\\Cargo' => $baseDir . '/models/Cargo.php',
    'Model\\CategoriaRubro' => $baseDir . '/models/CategoriaRubro.php',
    'Model\\CoordinadorPrograma' => $baseDir . '/models/CoordinadorPrograma.php',
    'Model\\DetalleActividad' => $baseDir . '/models/DetalleActividad.php',
    'Model\\DetalleFinanciamiento' => $baseDir . '/models/DetalleFinanciamiento.php',
    'Model\\FuenteActividadVista' => $baseDir . '/models/FuenteActividadVista.php',
    'Model\\FuenteFinanciamiento' => $baseDir . '/models/FuenteFinanciamiento.php',
    'Model\\FuentePresupuestoAnual' => $baseDir . '/models/FuentePresupuestoAnual.php',
    'Model\\IngresoEgresoAdminVista' => $baseDir . '/models/IngresoEgresoAdminVista.php',
    'Model\\Login' => $baseDir . '/models/Login.php',
    'Model\\OieComprobante' => $baseDir . '/models/OieComprobante.php',
    'Model\\OieTipoComprobante' => $baseDir . '/models/OieTipoComprobante.php',
    'Model\\OtrosIngresosEgresos' => $baseDir . '/models/OtrosIngresosEgresos.php',
    'Model\\Persona' => $baseDir . '/models/Persona.php',
    'Model\\Poa' => $baseDir . '/models/Poa.php',
    'Model\\PoaIndicadores' => $baseDir . '/models/PoaIndicadores.php',
    'Model\\Producto' => $baseDir . '/models/Producto.php',
    'Model\\Programa' => $baseDir . '/models/Programa.php',
    'Model\\ProgramaPoaVista' => $baseDir . '/models/ProgramaPoaVista.php',
    'Model\\ProgramasinCoordinadorVista' => $baseDir . '/models/ProgramasinCoordinadorVista.php',
    'Model\\Rendicion' => $baseDir . '/models/Rendicion.php',
    'Model\\RendicionAdminVista' => $baseDir . '/models/RendicionAdminVista.php',
    'Model\\RendicionFuentesVista' => $baseDir . '/models/RendicionFuentesVista.php',
    'Model\\ReporteEgresosVista' => $baseDir . '/models/ReporteEgresosVista.php',
    'Model\\ReporteFuentesProgramaVista' => $baseDir . '/models/ReporteFuentesProgramaVista.php',
    'Model\\ReporteFuentesVista' => $baseDir . '/models/ReporteFuentesVista.php',
    'Model\\ReporteIngresosVista' => $baseDir . '/models/ReporteIngresosVista.php',
    'Model\\ReporteMovimientosXlsxBuilder' => $baseDir . '/models/ReporteMovimientosXlsxBuilder.php',
    'Model\\ReportePoaRubros' => $baseDir . '/models/ReportePoaRubros.php',
    'Model\\ReportePoaTipoRubros' => $baseDir . '/models/ReportePoaTipoRubros.php',
    'Model\\ReporteRendicionXlsxBuilder' => $baseDir . '/models/ReporteRendicionXlsxBuilder.php',
    'Model\\ReporteRendicionesVista' => $baseDir . '/models/ReporteRendicionesVista.php',
    'Model\\Resultado' => $baseDir . '/models/Resultado.php',
    'Model\\Rubro' => $baseDir . '/models/Rubro.php',
    'Model\\RubroVista' => $baseDir . '/models/RubroVista.php',
    'Model\\SaldoFuenteFinanciamientoVista' => $baseDir . '/models/SaldoFuenteFinanciamientoVista.php',
    'Model\\SaldoSobreVista' => $baseDir . '/models/SaldoSobreVista.php',
    'Model\\SubCategoriaRubro' => $baseDir . '/models/SubCategoriaRubro.php',
    'Model\\TipoCambio' => $baseDir . '/models/TipoCambio.php',
    'Model\\TipoComprobante' => $baseDir . '/models/TipoComprobante.php',
    'Model\\TipoPrograma' => $baseDir . '/models/TipoPrograma.php',
    'Model\\TipoRubro' => $baseDir . '/models/TipoRubro.php',
    'Model\\TransferenciaInstitucional' => $baseDir . '/models/TransferenciaInstitucional.php',
    'Model\\Usuario' => $baseDir . '/models/Usuario.php',
    'Model\\UsuarioDisponiblePrograma' => $baseDir . '/models/UsuarioDisponiblePrograma.php',
    'Model\\UsuarioVista' => $baseDir . '/models/UsuarioVista.php',
    'Model\\UsuariosCoordinadorVista' => $baseDir . '/models/UsuariosCoordinadorVista.php',
    'Model\\VistaSaldoContable' => $baseDir . '/models/VistaSaldoContable.php',
    'Model\\VistaTotalEgresos' => $baseDir . '/models/VistaTotalEgresos.php',
    'Model\\VistaTotalIngresos' => $baseDir . '/models/VistaTotalIngresos.php',
    'Model\\XlsxValorSeguroBinder' => $baseDir . '/models/XlsxValorSeguroBinder.php',
